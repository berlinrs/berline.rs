---
title: "Rust Berlin on location 🏳️‍🌈 – Edition 016"
date: "2026-08-06 19:00 +0200"
categories: meetup
location: ferrous_slint_kdab
links:
    "Meetup.com": https://www.meetup.com/rust-berlin/events/315966137/
talks: false
---
...
<p>Please <a href="https://www.meetup.com/rust-berlin/events/315966137/" target="_blank">RSVP on meetup.com to save your spot</a>, since our location is relatively small, and the Rust Berlin meetup org has a wide reach and commonly attracts a large number of participants.</p>
...
<p>This time, Bram will lead an <strong>interactive introduction to <a href="https://mise.jdx.dev/">*mise-en-place*</a></strong>.</p>
<p>Expect around 30 minutes of guided exploration, followed by 30 minutes of hands-on demo and play-along time with questions. Feel free to bring your laptops if you want to follow along during the second half!</p>
<blockquote>
<p>Every software project needs software itself. There is often custom tooling, and important standard tools beyond Cargo that need to be the same version between all developers. Development environments differ from production.</p>
<p>"<a href="https://mise.jdx.dev/">Mise-en-place</a>" is a relatively new approach that's both a package manager and a task runner, and it complements Cargo particularly well. We'll discuss where "Mise" shines, where tools like Pixi/Nix/Bazel might be a better choice, and we'll see dev tooling in a new light.</p>
</blockquote>
<p>Both <a href="https://www.nushell.sh/">Nushell</a> and <a href="https://github.com/jj-vcs/jj">jj</a> will make brief appearances as well. If anyone would like to lead a session on either topic at one of our upcoming editions, that would be wonderful — reach out in our Zulip chat!</p>
...
<p>6 August 2026 is our sixteenth meeting. Our next projected meetings are going to occur on the following dates:</p>
...
<p>We are part of <a href="https://berline.rs/" target="_blank" rel="nofollow">https://berline.rs/</a> and like to hang out in the <a href="https://rust-berlin.zulipchat.com/join/gap4pdbz7xsquliiz7tgcyuk/" target="_blank" rel="nofollow"><strong>Rust Berlin on location 🏳️‍🌈</strong> Zulip chat</a>. You are very welcome to join!</p>
